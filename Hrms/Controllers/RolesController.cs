    ...
    public class RolesController : BaseController
    {
        ...
        public IActionResult Listener()
        {
            try
            {
                ...
                int recordsTotal = 0;
                var Data = (from x in dbContext.Roles select x);
                ...
                var resultData = from x in resultList.Where(x => x.SubscriptionId == SessionData.SubscriptionId && x.OrganizationId == SessionData.OrganizationId && !x.IsDeleted)
                                 select new { x.Id, Subscription = x.Subscription.Title, Organization = x.Organization.Name, x.Name,
        ...
        public Roles GetRecord(int? id)
        {
            ...
            var Record = dbContext.Roles.FirstOrDefault(o => o.Id == id && o.SubscriptionId == UserRecord.SubscriptionId && o.IsDeleted == false);
            if (Record != null)
            {
                DropdownForHRMS(this);
            }
        ...
        [HttpPost]
        public IActionResult Save(Roles model)
        {
        ...
        public JsonResult Delete(int? Id)
        {
            ...
            try
            {
                if (IsUserLogin(this))
                {
                    ...
                    {
                        UserSessionData UserRecord = GetUserData(this);
                        var RecordToDelete = dbContext.Roles.FirstOrDefault(o => o.Id == Id && o.SubscriptionId == UserRecord.SubscriptionId && o.OrganizationId == UserRecord.OrganizationId);
