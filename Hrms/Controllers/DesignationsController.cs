    ...
    public class DesignationsController : BaseController
    {
        ...
        public IActionResult Listener()
        {
            try
            {
                ...
                int recordsTotal = 0;
                var Data = (from x in dbContext.Designations select x);
        ...
        public IActionResult Add()
        {
            ...
            return View("Form", new Designations());
        }
        public Designations GetRecord(int? id)
        {
            UserSessionData UserRecord = GetUserData(this);
            var Record = dbContext.Designations.FirstOrDefault(o => o.Id == id && o.SubscriptionId == UserRecord.SubscriptionId && o.IsDeleted == false);
            if (Record != null)
            {
                DropdownForHRMS(this);
            }
        ...
        public IActionResult Edit(int? id)
        {
            ...
            {
                return Redirect(ViewBag.WebsiteURL + "designations/add");
            }
        }
        ...
        [HttpPost]
        public IActionResult Save(Designations model)
        {
                ...
                if (IsUserLogin(this))
                {
                    ...
                    if (isAddOrUpdate)
                    {
                        ...
                        else
                        {
                            ...
                            dbContext.Designations.Update(model);
                            ajaxResponse.Success = true;
                            ajaxResponse.Message = "Record Updated Successfully";
                        }
                        dbContext.SaveChanges();
                        ajaxResponse.TargetURL = ViewBag.WebsiteURL + "designations";
                    }
                }
                else
                {
        ...
        public JsonResult Delete(int? Id)
        {
            ...
            try
            {
                if (IsUserLogin(this))
                {
                    ...
                    {
                        UserSessionData UserRecord = GetUserData(this);
                        var RecordToDelete = dbContext.Designations.FirstOrDefault(o => o.Id == Id && o.SubscriptionId == UserRecord.SubscriptionId && o.OrganizationId == UserRecord.OrganizationId);
                        if (RecordToDelete != null)
                        {
                            ...
                            else
                            {
                                ...
                                dbContext.Designations.Update(RecordToDelete);
                                dbContext.SaveChanges();
                                ajaxResponse.Success = true;
